...
export default function Settings() {
  ...
  const [cardConfig, setCardConfig] = useState(() => ({
    schoolName: localStorage.getItem(getStorageKey('cardSchoolName')) || 'SMK AL-HIKAM',
    schoolAddress: localStorage.getItem(getStorageKey('cardSchoolAddress')) || 'Sendang Agung, Lampung Tengah, Lampung',
    principalName: localStorage.getItem(getStorageKey('cardPrincipalName')) || 'Ahmad Zaenuri, S.Pd',
